...
describe('Create tweet tests', () => {
    ...
    test('should not create a tweet and through exception', async () => {
...
describe('Get all tweet tests',  () => {
    ...
    test('testing limit for get all', async () => {
        ...
        const tweetsArray = [{...data, createdAt: '2024-02-12', updatedAt:'2024-02-12' }, {...data, createdAt: '2024-02-12', updatedAt:'2024-02-12' }, {...data, createdAt: '2024-02-12', updatedAt:'2024-02-12' }];
